...
*/
    'core' => [
        ...
        'qiniu'=>[
            'accessKey'=>'0bpu8FVYy23CTDdFvTBuEdDnsGHp-zOuOLhJ6chQ',
            'secretKey'=>'kOgG3bLgpcQkGsYttKJuV8zFc0IhcStwZpLGcJoy',
            'bucket'=>'lbzj',
            'url'=>'http://osob6w0s8.bkt.clouddn.com',//七牛分配的CDN域名,注意带上http://
    ...
    'upload' => [
        ...
        "fileAllowFiles" => [".mp4",
            ...
            ".flv", ".swf", ".mkv", ".avi", ".rm", ".rmvb", ".mpeg", ".mpg",
            ".ogg", ".ogv", ".mov", ".wmv",  ".webm", ".mp3", ".wav", ".mid",
