...
<head>
    ...
    <style>
        * {font-family: "Lucida Grande", Lucida Sans Unicode, Hiragino Sans GB, WenQuanYi Micro Hei, Verdana, Aril, sans-serif;}
        body {background: url(/background.jpg) center no-repeat;height: auto;}
...
<div class="login-box">
    <div class="login-box-body">
        <div class="login-logo">老兵之家</div>
        <p class="login-box-msg">山有木兮木有枝，心悦君兮君不知。</p>
        @include('admin.layouts.notify')
        <form action="{{ route('admin.login') }}" method="post">
            <div class="form-group has-feedback">
                <input type="email" class="form-control" name="email" placeholder="账号" required>
